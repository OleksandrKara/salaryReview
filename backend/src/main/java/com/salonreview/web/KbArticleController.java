...
public class KbArticleController {
    ...
    public ResponseEntity<KbArticleDto> create(@RequestBody WriteRequest body,
        ...
        KbArticle a = articles.create(body.title(), body.category(), body.body(), body.visibleRoles(),
                me.getUsername());
    ...
    public ResponseEntity<KbArticleDto> update(@PathVariable Long id, @RequestBody WriteRequest body) {
        if (isBlank(body.title()) || isBlank(body.category())) return ResponseEntity.badRequest().build();
        return articles.update(id, body.title(), body.category(), body.body(), body.visibleRoles())
    ...
    private static KbArticleDto toDto(KbArticle a) {
        return new KbArticleDto(a.getId(), a.getTitle(), a.getCategory(), a.getBody(),
    ...
    public record KbArticleDto(Long id, String title, String category, String body,
    ...
    public record WriteRequest(String title, String category, String body, List<Role> visibleRoles) {}
