 ...
 * way in to create the rest of the users. Idempotent: does nothing once any account exists.
 */
@Configuration
public class OwnerBootstrap {
    ...
    @Bean
    ApplicationRunner seedOwner(AppUserRepository users, PasswordEncoder encoder,
