...
class LapsedCustomerWinbackSchedulerTest {
    ...
    void setUp() {
        ...
        scheduler = new LapsedCustomerWinbackScheduler(eligibilityRepository, sendRepository, square,
                automationService, consentRepository, rebookingProperties, messageLogService, configService,
