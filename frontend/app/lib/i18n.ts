...
const STRINGS = {
  ...
  navAutomationsOverview: { EN: 'Overview', RU: 'Обзор' },
  navAutomationsSms: { EN: 'SMS', RU: 'SMS' },
  navAutomationsEmail: { EN: 'Email', RU: 'Email' },
  ...
  missedBookingsDesc: {
    EN: 'When a customer wants an appointment and there’s nowhere to put them — every provider already booked — log it here with your best estimate of what that visit would have been worth. Over time this shows whether demand is consistently outrunning capacity enough to justify hiring another provider.',
    RU: 'Когда клиент хочет записаться, а свободных окон нет — все мастера уже заняты — зафиксируйте это здесь с оценкой, сколько могла бы стоить эта запись. Со временем это покажет, действительно ли спрос постоянно превышает возможности, чтобы оправдать найм ещё одного мастера.',
  },
  missedBookingDate: { EN: 'Date', RU: 'Дата' },
  missedBookingTimeOptional: { EN: 'Time (optional)', RU: 'Время (необязательно)' },
  missedBookingRevenue: { EN: 'Estimated revenue', RU: 'Оценка дохода' },
  missedBookingServiceOptional: { EN: 'What did they want? (optional)', RU: 'Что хотели? (необязательно)' },
  missedBookingServicePlaceholder: { EN: 'e.g. Balayage', RU: 'например, Балаяж' },
  missedBookingAdd: { EN: 'Log it', RU: 'Зафиксировать' },
  missedBookingAdding: { EN: 'Logging…', RU: 'Сохранение…' },
  missedBookingNone: { EN: 'No missed bookings logged.', RU: 'Упущенных записей пока нет.' },
  missedBookingDelete: { EN: 'Delete', RU: 'Удалить' },
  missedBookingConfirmDelete: { EN: 'Delete this missed booking?', RU: 'Удалить эту упущенную запись?' },
  missedBookingErrCreate: { EN: 'Could not log this missed booking.', RU: 'Не удалось сохранить запись.' },
  missedBookingErrCreateFallback: { EN: 'Failed to create', RU: 'Не удалось создать' },
  missedBookingErrDelete: { EN: 'Could not delete.', RU: 'Не удалось удалить.' },
  missedBookingTotalRevenue: { EN: 'Total missed revenue', RU: 'Всего упущено' },
  missedBookingTotalCount: { EN: 'Missed bookings', RU: 'Упущенных записей' },
  missedBookingAvgRevenue: { EN: 'Average per miss', RU: 'Среднее за запись' },
  missedBookingByMonth: { EN: 'By month', RU: 'По месяцам' },
  missedBookingByWeekday: { EN: 'By day of week', RU: 'По дням недели' },
  missedBookingColTime: { EN: 'Time', RU: 'Время' },
  missedBookingColService: { EN: 'Wanted', RU: 'Хотели' },
  missedBookingColLoggedBy: { EN: 'Logged by', RU: 'Кто зафиксировал' },
  missedBookingWeekdaySun: { EN: 'Sunday', RU: 'Воскресенье' },
  missedBookingWeekdayMon: { EN: 'Monday', RU: 'Понедельник' },
  missedBookingWeekdayTue: { EN: 'Tuesday', RU: 'Вторник' },
  missedBookingWeekdayWed: { EN: 'Wednesday', RU: 'Среда' },
  missedBookingWeekdayThu: { EN: 'Thursday', RU: 'Четверг' },
  missedBookingWeekdayFri: { EN: 'Friday', RU: 'Пятница' },
  missedBookingWeekdaySat: { EN: 'Saturday', RU: 'Суббота' },
