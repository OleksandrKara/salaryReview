  ...
  return (
    <section className="mt-8">
      ...
      <div className="flex flex-col gap-3">
        <CollapsibleHalf title="1–15" lines={first} settlement={firstHalf} message={detail.firstHalfMessage} tierApplied={tierApplied} baseRate={firstHalf.appliedRate} />
        <CollapsibleHalf title="16–end" lines={second} settlement={secondHalf} message={detail.secondHalfMessage} tierApplied={tierApplied} baseRate={firstHalf.appliedRate} />
      </div>
    </section>
  );
}
